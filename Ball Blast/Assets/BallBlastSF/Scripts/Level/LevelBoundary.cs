...
public class LevelBoundary : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 ScrenResolution;
    ...
    private void Awake()
    {
        ...
        {
            ScrenResolution.x = Screen.width;
            ScrenResolution.y = Screen.height;
    ...
    public float RightBorder
    {
        get
        {
            return Camera.main.ScreenToWorldPoint(new Vector3(ScrenResolution.x, 0, 0)).x;
        }
    }
#if UNITY_EDITOR
